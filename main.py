...
def optimize_turn_between_vertical_lines(
    ...
    if debug:
        print(f"[SEARCH] EOL candidates={len(eol_candidates)}, SOL fixed at line head y={sol_data_y:.2f}")
...
if __name__ == "__main__":
    ...
    print_result(best)
    # plot_turn_solution(line1, line2, best, R, show_circles=True, figsize=(8, 10))
    plot_turn_solution(
        line1,
        line2,
        best,
        ...
        figsize=(12, 14),
        dpi=300,
        save_path="turn_solution_hd.png"
    )